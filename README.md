...
```js
module.exports = {
  siteTitle: "Rikus Wiehahn Blog", // Site title.
  ...
  siteTitleAlt: "Rikus Wiehahn Blog", // Alternative site title for SEO.
  siteLogo: "/logos/logo-1024.png", // Logo used for SEO and manifest.
  siteUrl: "https://rikuswiehahn.com", // Domain of your website without pathPrefix.
  pathPrefix: "/gatsby-advanced-starter", // Prefixes all links. For cases when deployed to example.github.io/gatsby-advanced-starter/.
  siteDescription: "Essays on business, design and tech.", // Website description used for RSS feeds/meta description tag.
  ...
  userTwitter: "https://twitter.com/RikusWiehahn", // Optionally renders "Follow Me" in the UserInfo segment.
  userLocation: "Hamilton, New Zealand", // User location to display in the author segment.
  userAvatar: "/static/mugshot.jpg", // User avatar to display in the author segment.
  userDescription:
  ...
  copyright: "Copyright © 2019. Rikus Wiehahn", // Copyright string for the footer of the website and RSS feed.
